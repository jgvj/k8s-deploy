...
JAVA_OPTS="$JAVA_OPTS -Djava.protocol.handler.pkgs=org.apache.catalina.webresources  -javaagent:$CATALINA_BASE/lib/org.jacoco.agent-0.7.9-runtime.jar=output=tcpserver,address=0.0.0.0,port=6300"
